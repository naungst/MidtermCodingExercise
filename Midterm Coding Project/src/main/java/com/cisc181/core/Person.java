...
public abstract class Person implements java.io.Serializable {
	...
	//  method will throw person exception if age is > 100 from todays date and if
	// phone number if invalid in North America
	public Person validate() throws PersonException {
